...
<div class="modal fade add" id="add" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <form class="needs-validation" enctype="multipart/form-data" action="student_rent_room_add.php" method="post" novalidate>
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Add Rent</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php
                                            $student = mysqli_query($conn,"select * from tbl_users where role_id = 2 and status = 'Approved'") or die (mysqli_error($conn));
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="">
                                                ...
                                                <input type="date" class="form-control" name="date_in" id="validationCustom03"  required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid data.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="">
                                                ...
                                                <input type="date" class="form-control" name="date_out" id="validationCustom03"  required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid data.
                                                </div>
                                            </div>
