...
<div class="modal fade customer" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <form class="needs-validation" enctype="multipart/form-data" action="marketing_formAdd.php" method="post" novalidate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <option value="titol_per_kit">Total Per Kit</option>
                                                </select>
                                                <div class="invalid-feedback">
                                                    Please provide a valid data.
                                                </div>
                                ...
                                <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="validationCustom03">Price</label>
                                                 <input type="text" class="form-control" name="price" id="item_price" onkeyup="sum();" placeholder="Item Price">
                                                <div class="invalid-feedback">
                                                    Please provide a valid data.
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" onkeyup="sum();" name="no_of_orders" id="no_order" placeholder="Enter No. of Orders"  required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid data.
                                                </div>
                                         </div>
...
<script type="text/javascript">
  function sum() {
    ...
    var total_sale = parseInt(item_price) * parseInt(no_order);
