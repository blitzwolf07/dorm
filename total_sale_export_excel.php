...
$fields  = array('No','Client Name','Invoice #','Product','Item','Price','No. of Orders','Total');
...
if($query->num_rows >0) {
	...
	$lineData  = array($i++, $row_client['customer_name'], $row['invoice_number'],$row_supplier['supplier_name'], $row_item['item_name'], $row['item_price'], $row['no_of_orders'], $row['total_sale']);
