                                ...
                                <div class="col-md-2">
                                    <div class="float-end">
                                        ...
                                        <div class="dropdown-menu" id="export-menu">
                                            <a href="marketing_inventory_export_excel.php" id="export_data" name='export_data' class="dropdown-item dwn">Excel</a>
                                    ...
                                    while($row_marketing_inventory = mysqli_fetch_assoc($marketing_inventory)) {
                                     ...
                                     ?>
                                        <tr>
                                            ...
                                            <td><?php echo "₱", $row_marketing_inventory['total_sale'] ?></td>
                                            <td><?php echo date("F d, Y",strtotime($row_marketing_inventory['date'])) ?></td>
                                        </tr>
                                    <?php
