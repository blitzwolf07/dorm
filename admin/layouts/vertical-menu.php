        ...
        <div class="d-flex">
           ...
           <!--  <?php if($role == '2') { ?>
             ...
             <button type="button" class="btn header-item noti-icon position-relative">
                    ...
                    <span class="badge bg-danger text-danger rounded-pill"><?php echo $row_pending ?> </span>
                </button> 
              </a>          
            </div>
            <?php } ?>
            ...
            <a href="applicants.php">
                <button type="button" class="btn header-item noti-icon position-relative">
                    ...
                    <span class="badge bg-danger rounded-pill"><?php echo $row_applicants ?></span>
                </button>
            </a>
            </div>
            <?php } ?>  -->
            ...
            <?php if($role == '2') { ?>
                <li>
                    <a href="fullcalendar/index.php">
                        ...
                        <span data-key="t-dashboard">Leave</span>
                    </a>
                </li>
            <?php } ?>
                <!-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="Product_Category.php" data-key="t-login"><i data-feather="grid"></i>Product  Category</a></li>
                        <li><a href="product.php" data-key="t-register"> <i data-feather="book"></i>Add Product</a></li>
                    </ul>
                </li> -->
