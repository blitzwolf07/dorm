        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="fullcalendar/index.php" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">Sal Lucas Lablibe</span>
                    </span>
                </a>
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="fullcalendar/index.php" id="topnav-dashboard" role="button">
